...
type PreviewTripRequest struct {
	...
	StartLocation *Coordinates           `protobuf:"bytes,2,opt,name=startLocation,proto3" json:"startLocation,omitempty"`
	EndLocation   *Coordinates           `protobuf:"bytes,3,opt,name=endLocation,proto3" json:"endLocation,omitempty"`
...
func (x *PreviewTripRequest) GetStartLocation() *Coordinates {
	if x != nil {
...
func (x *PreviewTripRequest) GetEndLocation() *Coordinates {
	if x != nil {
...
const file_trip_proto_rawDesc = "" +
	...
	"\rstartLocation\x18\x02 \x01(\v2\x11.trip.CoordinatesR\rstartLocation\x123\n" +
	"\vendLocation\x18\x03 \x01(\v2\x11.trip.CoordinatesR\vendLocation\"~\n" +
	...
	"\bcarPlate\x18\x04 \x01(\tR\bcarPlate\"G\n" +
	...
	"\bGeometry\x123\n" +
	"\vcoordinates\x18\x01 \x03(\v2\x11.trip.CoordinatesR\vcoordinates\"\x82\x01\n" +
	"\bRideFare\x12\x0e\n" +
...
var file_trip_proto_goTypes = []any{
	...
	(*Coordinates)(nil),         // 6: trip.Coordinates
	(*Route)(nil),               // 7: trip.Route
	(*Geometry)(nil),            // 8: trip.Geometry
	(*RideFare)(nil),            // 9: trip.RideFare
}
var file_trip_proto_depIdxs = []int32{
	6,  // 0: trip.PreviewTripRequest.startLocation:type_name -> trip.Coordinates
	6,  // 1: trip.PreviewTripRequest.endLocation:type_name -> trip.Coordinates
	7,  // 2: trip.PreviewTripResponse.route:type_name -> trip.Route
	...
	7,  // 6: trip.Trip.route:type_name -> trip.Route
	5,  // 7: trip.Trip.driver:type_name -> trip.TripDriver
	8,  // 8: trip.Route.geometry:type_name -> trip.Geometry
	6,  // 9: trip.Geometry.coordinates:type_name -> trip.Coordinates
